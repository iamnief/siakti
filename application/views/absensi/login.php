...
<body class="text-center">
	<form class="form-signin">
		...
		<h1 class="h3 mb-3 font-weight-normal">Masuk Sebagai Mahasiswa</h1>
		<label for="inputEmail" class="sr-only">Username</label>
		<input type="email" id="inputEmail" class="form-control" placeholder="Masukkan username" required autofocus>
