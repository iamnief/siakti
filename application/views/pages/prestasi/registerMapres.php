					...
					<div class="card-body">
						<div class="row justify-content-center">
								...
								<div class="card text-left">
									<div class="card-body mt-n2">
										<div class="baris">
											...
											<h5 class="text-info mt-n3 mb-n2">Selasa, 31 Maret 2020 01:00</h4>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-7 ml-4">
								<h2 class="text-dark mb-3">Pendaftaran Mahasiswa Berprestasi TIK</h2>
								<h2 class="text-dark font-weight-light mb-2">Pilih Daftar Prestasi :</h2>
								<div class="form-group">
									<select name="" class="form-control" id="">
										<option value="Juara 1 Web Development" selected>Juara 1 Web Development</option>
										<option value="">...</option>
									</select>
								</div>
								<div class="form-group">
									<input type="text" name="" class="form-control" placeholder="Nilai TOEFL" id="">
								</div>
